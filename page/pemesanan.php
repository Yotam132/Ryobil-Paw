...
<body>
    ...
    <div class="bg mx-auto text-center p-3">
        <h2 style="color:white;"><b>PEMESANAN</b></h2>
    </div>
    
    <!-- Pemesanan Content -->
        
    <div class="container top-50 start-50 translate-middle mt-5 mb-5" style="padding-bottom:70px;">
    <h2 style="color:#f28f2a;margin-bottom:50px;"><b>Silahkan Isi Data</b></h2>
        <form action="../process/pemesananProcess.php" method="post">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Nama Pengirim" id="pengirim_nama" name="pengirim_nama" required>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 mb-4">
                    <label for="exampleInputEmail1" class="form-label">Nama Penerima</label>
                    <input type="text" class="form-control" placeholder="Nama Penerima" id="penerima_nama" name="penerima_nama" required>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 mb-4">
                    <label for="exampleInputEmail1" class="form-label">No.Telp Pengirim</label>
                    <input type="tel" pattern="[0-9]{12}" placeholder="0821XXXXXXXX" class="form-control" id="pengirim_nomor" name="pengirim_nomor" required>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 mb-4">
                    <label for="exampleInputEmail1" class="form-label">No. Telp Penerima</label>
                    <input type="tel" pattern="[0-9]{12}" placeholder="0821XXXXXXXX" class="form-control" id="penerima_nomor" name="penerima_nomor" required>
                </div>
                                        
                <div class="col-xs-6 col-sm-6 col-md-6 mb-4">
                    <label for="exampleInputEmail1" class="form-label">Alamat Pengirim</label>
                    <input type="text" class="form-control" id="pengirim_alamat" placeholder="Alamat Penerima" name="pengirim_alamat" required>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 mb-4">
                    <label for="exampleInputEmail1" class="form-label">Alamat Penerima</label>
                    <input type="text" class="form-control" id="penerima_alamat" placeholder="Alamat Penerima" name="penerima_alamat" required>
                </div>

                <div class="col-xs-12 col-sm-12 col-md-12 mt-5 text-center">
                    <button type="submit" class="btn btn-primary" name="pesan" style="background-color:#f28f2a;">Pesan</button>
                </div>
            </div>
        </form>
    </div>
